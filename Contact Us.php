            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="banner_text text-center">
                        <h1 class="font_1 color_white wow fadeInDown" data-wow-delay="0.2s">Contact Us</h1>
                        <div class="breadcrumb wow fadeInDown"  data-wow-delay="0.2s"><a href="index.html">Home</a>&nbsp;<i class="fas fa-angle-double-right"></i>&nbsp;<a class="breadcrumb-active">Contact Us</a></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="contact_form wow fadeInLeft" data-wow-delay="0.3s">
                        <form method="POST" action="<?php echo url('contact_form.php') ?>">
                            ...
                            <button class="blue_btn btn font_2_bold text-uppercase wow fadeInLeft" data-wow-delay="0.3s" type="submit" value="add" name="submit">Submit Now</button>
                        </form>
                    </div>
                </div>
