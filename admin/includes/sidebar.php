        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="#service" <?php if ($active == 'service') echo 'data-active="true" aria-expanded="true"' ?> data-toggle="collapse" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="submenu list-unstyled collapse" id="service" data-parent="#accordionExample">
                            <li>
                                <a href="<?php echo url('add-service.php') ?>"> Add </a>
                            </li>
                            <li>
                                <a href="<?php echo url('service-list.php') ?>"> List </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu">
                        <a href="<?php echo url('contact-list.php') ?>" <?php if ($active == 'contact') echo 'data-active="true" aria-expanded="true"' ?> class="dropdown-toggle">
                            <div class="">
