...
<html lang="en">
    ...
    <section class="Services_banner_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="banner_text text-center">
                        <h1 class="font_1 color_white wow fadeInDown" data-wow-delay="0.2s">Application Design &amp; Development</h1>
                        <div class="breadcrumb wow fadeInDown" data-wow-delay="0.2s"><a href="index.html">Home</a>&nbsp;<i class="fas fa-angle-double-right"></i>&nbsp; <a href="Mobile Application Development.html">Services</a>&nbsp;<i class="fas fa-angle-double-right"></i>&nbsp; <a class="breadcrumb-active"> Application Design &amp; Development</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 wow fadeInLeft" data-wow-delay="0.2s">
                    <img src="assets/images/innerpages/mobile application.jpg">
                 </div>
